...
- Read [Contribution Guidelines](https://ida.innerbytes.com/#9-contributing-to-the-idajs-project)
...
IdaJS source code: Copyright (c) 2024–2026 Andriy Tevelyev ([Innerbytes Software](https://innerbytes.com)) and the IdaJS contributors. This notice applies only to the IdaJS source code added on top of the LBA2 community sources, and except third party source code. The combined work (IdaJS + LBA2 sources) is distributed under the GNU General Public License v2 (GPLv2).
