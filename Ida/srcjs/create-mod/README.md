...
```pwsh
npx @idajs/create-mod [project-name] [options]
```

For all available options and examples, run:

```pwsh
npx @idajs/create-mod --help
```
...
- Project structure with `src/` folder for your code
- `media/` folder for custom images and sprites
- Development scripts for building, watching, and syncing
...
Created by Andriy Tevelyev | [innerbytes.com](https://innerbytes.com) | [Support the project](https://innerbytes.com/#about)
